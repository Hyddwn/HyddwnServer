	...
	protected override async Task Keywords(string keyword)
	{
		switch (keyword)
		{
			...
			case "skill_counter_attack":
				...
				Msg("Your legs are all tensed up. You can't react in time like that.<br/>Loosen your left leg to make sure you can absorb your enemy's strength...<br/>Yes. That's it. Now you look like you're ready.", Button("Continue", "@yes"));
				await Select();
