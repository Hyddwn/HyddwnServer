...
public class CaitinShop : NpcShopScript
{
	public override void Setup()
	{
		...
		Add("Grocery", 50111);     // Carrot x1
		Add("Grocery", 50112);     // Strawberry x1
		Add("Grocery", 50112, 10); // Strawberry x10
		Add("Grocery", 50121);     // Butter x1
		Add("Grocery", 50121, 10); // Butter x10
		Add("Grocery", 50138);     // Cabbage x1
		Add("Grocery", 50139);     // Button Mushroom x1
		Add("Grocery", 50142);     // Onion x1
		Add("Grocery", 50142, 10); // Onion x10
		Add("Grocery", 50131);     // Sugar x1
		Add("Grocery", 50131, 10); // Sugar x10
		Add("Grocery", 50132);     // Salt x1
		Add("Grocery", 50132, 10); // Salt x10
		Add("Grocery", 50156);     // Pepper x1
		Add("Grocery", 50156, 10); // Pepper x10
		Add("Grocery", 50145);     // Olive Oil x1
		Add("Grocery", 50145, 10); // Olive Oil x10
		Add("Grocery", 50153);     // Deep Fry Batter x1
		Add("Grocery", 50148);     // Yeast x1
		...
		if (IsEnabled("MasterChef"))
		{
			...
			Add("Grocery", 50018);     // Baking Chocolate x1
			...
			Add("Grocery", 50108);     // Chicken Wings x1
			...
			Add("Grocery", 50186);     // Red Pepper Powder x1
