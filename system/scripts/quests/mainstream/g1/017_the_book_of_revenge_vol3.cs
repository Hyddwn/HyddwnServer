...
public class BookOfRevengeVol3_1Quest : GeneralScript
{
	...
	public async Task<HookResult> DuncanBeforeKeywords(NpcScript npc, params object[] args)
	{
		...
		if (keyword == "g1_glasgavelen")
		{
			if (npc.HasKeyword("g1_26"))
			{
				...
				npc.Msg(L("Does the third book of Fomors cover that?<br/>I'd like to read it. If you have it on you, please let my see it."), npc.Button(L("Here it is."), "@yes"), npc.Button(L("No"), "@no"));
			}
			else if (npc.HasKeyword("g1_27"))
			{
				npc.Msg(L("I'd like to read the third book of Fomors. If you have it on you, please let my see it."), npc.Button(L("Here it is."), "@yes"), npc.Button(L("No"), "@no"));
			}
	...
	public async Task<HookResult> BryceBeforeKeywords(NpcScript npc, params object[] args)
	{
		...
		if (keyword == "g1_book_of_glasgavelen")
		{
			...
			npc.Msg(L("When this happenes, it's either on of those things."));
