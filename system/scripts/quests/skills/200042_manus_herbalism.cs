//--- Aura Script -----------------------------------------------------------
// Gather Base Herb (Manus)
//--- Description -----------------------------------------------------------
// Manus asks you to gather 1 Base Herb for him, in exchange for teaching
// you Herbalism.
//--- Notes -----------------------------------------------------------------
// Dialog is unofficial/copied from Dilys.
//---------------------------------------------------------------------------

public class GatherBaseHerbManusQuestScript : QuestScript
{
	public override void Load()
	{
		SetId(200042);
		SetName("Gather Base Herb");
		SetDescription("Didn't you say you were interested in Herbalism? If you get me [1 base herb] from Ciar Dungeon, I will teach you the Herbalism skill as a reward. - Manus");

		SetIcon(QuestIcon.Medicine);
		if (IsEnabled("QuestViewRenewal"))
			SetCategory(QuestCategory.Skill);

		AddObjective("gather", "Gather 1 Base Herb", 0, 0, 0, Gather(51104, 1)); // 1 Base Herb
		AddObjective("talk", "Give 1 Base Herb to Manus", 19, 881, 1194, Talk("manus"));
