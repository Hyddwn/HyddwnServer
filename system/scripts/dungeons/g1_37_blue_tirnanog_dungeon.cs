...
[DungeonScript("g1_37_blue_tirnanog_dungeon")]
public class AlbeyBlueDungeonScript : DungeonScript
{
	private const int OrbHits = 5;
	private const int FragmentId = 73030;
	...
	public override void OnBoss(Dungeon dungeon)
	{
		...
		dungeon.AddBoss(170103, 1); // Lycanthrope
	}
	...
	public override void OnCleared(Dungeon dungeon)
	{
		...
		for (int i = 0; i < count; ++i)
		{
			...
			treasureChest.AddGold(rnd.Next(200, 800)); // Gold
