//--- Aura Script -----------------------------------------------------------
// Albey Silver Dungeon
//--- Description -----------------------------------------------------------
// Dungeon to get one of the four fragments for the Black Orb in.
//---------------------------------------------------------------------------

[DungeonScript("g1_37_silver_tirnanog_dungeon")]
public class AlbeySilverDungeonScript : DungeonScript
{
	...
	public override void OnCleared(Dungeon dungeon)
	{
		...
		for (int i = 0; i < count; ++i)
		{
			...
			treasureChest.AddGold(rnd.Next(272, 608)); // Gold
