...
[DungeonScript("g1_37_green_tirnanog_dungeon")]
public class AlbeyGreenDungeonScript : DungeonScript
{
	private const int OrbHits = 5;
	private const int FragmentId = 73027;
	...
	{
		dungeon.AddBoss(160001, 3); // Heavy Gargolye
		dungeon.AddBoss(160002, 5); // Light Gargolye
	}
