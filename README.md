...
and send it to us in some form. The information you give us will help developers
to implement the features. You can also keep a lookout for issues where need
help or information.

### 2. Bug reports
Report bugs via issues, so they can be fixed ASAP.

### 3. Pull Requests
The fastest way to get contributions into the source is a pull request, which,
...
if NA was just updated, or create an issue.
