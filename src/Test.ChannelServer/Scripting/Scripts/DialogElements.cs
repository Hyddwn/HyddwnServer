...
namespace Aura.Tests.Channel.Scripting.Scripts
{
    public class DialogElementTests
    {
        ...
        public void ElementComposition()
        {
            ...
            elements.Render(ref sb);
            Assert.Equal("<button title='Foobar1' keyword='@foobar1' /><button title='Foobar2' keyword='@foobar2' />",
                sb.ToString());
            sb.Clear();
            ...
            elements.Render(ref sb);
            Assert.Equal(
                "<button title='Foobar1' keyword='@foobar1' /><button title='Foobar3' keyword='@foobar3' /><button title='Foobar2' keyword='@foobar2' />",
                sb.ToString());
            sb.Clear();
            ...
            elements.Render(ref sb);
            Assert.Equal(
                "<button title='Foobar4' keyword='@foobar4' /><button title='Foobar3' keyword='@foobar3' /><button title='Foobar2' keyword='@foobar2' />",
                sb.ToString());
            sb.Clear();
            ...
            elements.Render(ref sb);
            Assert.Equal(
                "<button title='Foobar5' keyword='@foobar5' /><button title='Foobar4' keyword='@foobar4' /><button title='Foobar3' keyword='@foobar3' /><button title='Foobar2' keyword='@foobar2' />",
                sb.ToString());
            sb.Clear();
            ...
            elements.Render(ref sb);
            Assert.Equal(
                "<button title='Foobar5' keyword='@foobar5' /><button title='Foobar4' keyword='@foobar4' /><button title='Foobar3' keyword='@foobar3' /><button title='Foobar2' keyword='@foobar2' /><button title='Foobar6' keyword='@foobar6' />",
                sb.ToString());
            sb.Clear();
            ...
            elements = new DialogElement("foobar, <username/>!", new DialogButton("Foobar9"),
                new DialogButton("Foobar10"));

            elements.Render(ref sb);
            Assert.Equal(
                "foobar, <username/>!<button title='Foobar9' keyword='@foobar9' /><button title='Foobar10' keyword='@foobar10' />",
                sb.ToString());
            sb.Clear();
            ...
            elements.Render(ref sb);
            Assert.Equal(
                "barfoo?<button title='Foobar11' keyword='@foobar11' /><button title='Foobar9' keyword='@foobar9' /><button title='Foobar10' keyword='@foobar10' />",
                sb.ToString());
            sb.Clear();
        }
        ...
        public void Rendering()
        {
            ...
            Assert.Equal(
                "<listbox page_size='1' title='foobar' cancel='@end'><button title='test1' keyword='@test1' /></listbox>",
                sb.ToString());
            sb.Clear();

            new DialogList("foobar", 20, "@foo", new DialogButton("test1"), new DialogButton("test2")).Render(ref sb);
            Assert.Equal(
                "<listbox page_size='20' title='foobar' cancel='@foo'><button title='test1' keyword='@test1' /><button title='test2' keyword='@test2' /></listbox>",
                sb.ToString());
            sb.Clear();
