...
namespace Aura.Tests.Channel
{
    public class PositionTests
    {
        ...
        public void InCone()
        {
            ...
            Assert.Equal(false,
                topPos.InCone(centerPos, MabiMath.DegreeToRadian(45), 2000, MabiMath.DegreeToRadian(45)));
            Assert.Equal(true,
                topPos.InCone(centerPos, MabiMath.DegreeToRadian(68), 2000, MabiMath.DegreeToRadian(45)));
        }
