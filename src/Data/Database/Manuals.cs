...
namespace Aura.Data.Database
{
    ...
    public class ManualDb : DatabaseJson<ManualData>
    {
        ...
        {
            return Entries.FirstOrDefault(a => a.Category == category && a.Id == manualId);
        }

        protected override void ReadEntry(JObject entry)
        {
            entry.AssertNotMissing("category", "id", "manualItemId", "itemId", "exp", "rank", "maxProgress",
                "rainBonus", "materials", "finish");
