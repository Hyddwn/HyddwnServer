...
namespace Aura.Data.Database
{
    ...
    public class StatsBaseDb : DatabaseCsvIndexed<int, Dictionary<int, StatsBaseData>>
    {
        ...
        public StatsBaseData Find(int raceId, int age)
        {
            ...
            var race = Entries.GetValueOrDefault(raceId);
            if (race == null)
                return null;
        ...
        protected override void ReadEntry(CsvEntry entry)
        {
            ...
            if (!Entries.ContainsKey(info.Race))
                Entries[info.Race] = new Dictionary<int, StatsBaseData>();

            Entries[info.Race][info.Age] = info;
        }
    }
}