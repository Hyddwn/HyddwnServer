...
namespace Aura.Data.Database
{
    ...
    public class CollectingDb : DatabaseJsonIndexed<int, CollectingData>
    {
        ...
        {
            entry.AssertNotMissing("id", "target", "rightHand", "leftHand", "skillId", "delay", "durabilityLoss",
                "successRate", "resourceReduction", "resourceRecovering", "resourceReductionRainBonus");
            ...
            data.Products = ReadList(entry, "products");
            data.Products2 = ReadList(entry, "products2");
            data.FailProducts = ReadList(entry, "failProducts");
            data.FailProducts2 = ReadList(entry, "failProducts2");
