...
namespace Aura.Data.Database
{
    ...
    public class RaceData
    {
        public RaceData()
        {
            ...
            Skills = new List<RaceSkillData>();
            Equip = new List<RaceItemData>();
            Face = new RaceFaceData();
        }
    ...
    public class DropData
    {
        ...
        public DropData(int itemId, float chance, int amount = 0, int amountMin = 0, int amountMax = 0,
            uint? color1 = null, uint? color2 = null, uint? color3 = null, int prefix = 0, int suffix = 0,
            int expires = 0, int durability = -1, int? foodQuality = null, int? formId = null, float? scale = null,
            string metaData1 = null, string metaData2 = null)
        {
            if (amount != 0)
        ...
        public DropData Copy()
        {
            ...
            result.FoodQuality = FoodQuality;
    ...
    public class RaceItemData
    {
        public RaceItemData()
        {
            ...
            Color1s = new List<uint>();
            Color2s = new List<uint>();
            Color3s = new List<uint>();
        }
        ...
        {
            return ItemIds[rnd.Next(ItemIds.Count)];
        }
        ...
        public uint GetRandomColor1(Random rnd)
        {
            ...
            return Color1s[rnd.Next(Color1s.Count)];
        }
        ...
        public uint GetRandomColor2(Random rnd)
        {
            ...
            return Color2s[rnd.Next(Color2s.Count)];
        }
        ...
        public uint GetRandomColor3(Random rnd)
        {
            ...
            return Color3s[rnd.Next(Color3s.Count)];
        }
    }
    ...
    public class RaceFaceData
    {
        public RaceFaceData()
        {
            EyeColors = new List<int>();
            EyeTypes = new List<int>();
            MouthTypes = new List<int>();
            SkinColors = new List<int>();
        }
        ...
        public int GetRandomEyeColor(Random rnd)
        {
            ...
            return EyeColors[rnd.Next(EyeColors.Count)];
        }
        ...
        public int GetRandomEyeType(Random rnd)
        {
            ...
            return EyeTypes[rnd.Next(EyeTypes.Count)];
        }

        public int GetRandomMouthType(Random rnd)
        {
            if (MouthTypes.Count == 0)
                return 0;

            return MouthTypes[rnd.Next(MouthTypes.Count)];
        }
        ...
        public int GetRandomSkinColor(Random rnd)
        {
            ...
            return SkinColors[rnd.Next(SkinColors.Count)];
        }
    }

    [Flags]
    public enum RaceStands
    {
        KnockBackable = 0x01,
        KnockDownable = 0x02
    }
    ...
    public class RaceDb : DatabaseJsonIndexed<int, RaceData>
    {
        ...
        {
            name = name.ToLower();
            return Entries.FindAll(a => a.Value.Name.ToLower().Contains(name));
        }

        protected override void ReadEntry(JObject entry)
        {
            entry.AssertNotMissing("id", "name", "group", "tags", "gender", "vehicleType", "runSpeedFactor", "state",
                "invWidth", "invHeight", "range", "attackSpeed", "knockCount", "splashRadius", "splashAngle",
                "splashDamage", "stand", "ai", "color1", "color2", "color3", "cp", "life");
            ...
            if (!raceData.Skills.Exists(a => a.SkillId == (ushort) SkillId.CombatMastery))
                raceData.Skills.Add(new RaceSkillData
                {
                    SkillId = (ushort) SkillId.CombatMastery,
                    Rank = (byte) SkillRank.Novice
                });
            ...
            if ((actionInfo = AuraData.SpeedDb.Find(raceData.Group + "/walk")) != null)
                ...
                raceData.WalkingSpeed = actionInfo.Speed;
            else if ((actionInfo = AuraData.SpeedDb.Find(Regex.Replace(raceData.Group, "/.*$", "") + "/*/walk")) !=
                     null)
                raceData.WalkingSpeed = actionInfo.Speed;
