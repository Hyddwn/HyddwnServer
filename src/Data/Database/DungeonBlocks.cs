...
namespace Aura.Data.Database
{
    public class DungeonStyleData
    {
        ...
        {
            Blocks = new List<DungeonBlockData>();
        }
        ...
        {
            return Blocks.FirstOrDefault(a => a.Type == type);
        }
        ...
        public DungeonBlockData Get(DungeonBlockType type, int direction)
        {
            ...
            return Get(type, top, right, bottom, left);
        }
        ...
        {
            return Blocks.FirstOrDefault(a =>
                a.Type == type && a.Top == top && a.Right == right && a.Bottom == bottom && a.Left == left);
        }
    ...
    public class DungeonBlocksDb : DatabaseJsonIndexed<int, DungeonStyleData>
    {
        protected override void ReadEntry(JObject entry)
        {
            ...
            foreach (JObject propEntry in entry["blocks"])
            {
                ...
                if (!Entries.ContainsKey(data.Style))
                    Entries[data.Style] = new DungeonStyleData();

                Entries[data.Style].Blocks.Add(data);
            }
        }
    }
}