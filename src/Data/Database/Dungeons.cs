...
namespace Aura.Data.Database
{
    public class DungeonData
    {
        public DungeonData()
        {
            Floors = new List<DungeonFloorData>();
        }
    ...
    public class DungeonFloorData
    {
        ...
        {
            Sections = new List<DungeonSectionData>();
        }
    ...
    public class DungeonSectionData
    {
        ...
        {
            Puzzles = new List<DungeonPuzzleData>();
        }
    ...
    public class DungeonPuzzleData
    {
        ...
        {
            Groups = new List<DungeonMonsterGroupData>();
        }
    ...
    public class DungeonDb : DatabaseJsonIndexed<string, DungeonData>
    {
        ...
        {
            entry.AssertNotMissing("name", "style", "baseSeed", "lobby", "stairs", "saveStatue", "lastStatue", "door",
                "bossDoor", "bossExitDoor", "floors");
                                ...
                                foreach (var groupsEntry in puzzleEntry["groups"])
                                {
                                    ...
                                    foreach (JObject groupEntry in groupsEntry)
                                    {
                                        ...
                                        if (!string.IsNullOrWhiteSpace(feature) &&
                                            !AuraData.FeaturesDb.IsEnabled(feature))
                                            continue;
                                        ...
                                        if (!AuraData.RaceDb.Entries.ContainsKey(monsterData.RaceId))
                                            _warnings.Add(
                                                new DatabaseWarningException(
                                                    "Race '" + monsterData.RaceId + "' not found."));
            ...
            Entries[dungeonData.Name] = dungeonData;
        }
    }
}