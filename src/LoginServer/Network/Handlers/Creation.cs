...
namespace Aura.Login.Network.Handlers
{
    public partial class LoginServerHandlers : PacketHandlerManager<LoginClient>
    {
        ...
        public void CreateCharacter(LoginClient client, Packet packet)
        {
            ...
            // Check face/hair
            if (faceItemData == null || hairItemData == null ||
                faceItemData.Type != ItemType.Hair && faceItemData.Type != ItemType.Face ||
                hairItemData.Type != ItemType.Hair && hairItemData.Type != ItemType.Face)
            {
            ...
            Item.GenerateItemColors(ref items,
                client.Account.Name + character.Race + character.SkinColor + character.Hair + character.HairColor +
                character.Age + character.EyeType + character.EyeColor + character.MouthType + character.Face);
        ...
        public void CreatePartner(LoginClient client, Packet packet)
        {
            ...
            // Check face/hair
            if (faceItem == null || hairItem == null ||
                faceItem.Type != ItemType.Hair && faceItem.Type != ItemType.Face ||
                hairItem.Type != ItemType.Hair && hairItem.Type != ItemType.Face)
            {
