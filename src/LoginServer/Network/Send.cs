...
namespace Aura.Login.Network
{
    public static class Send
    {
        ...
        public static void LoginR(LoginClient client, Account account, long sessionKey,
            ICollection<ServerInfo> serverList)
        {
            var packet = new Packet(Op.LoginR, MabiId.Login);
        ...
        {
            CharacterInfoRequestR(client, op, null, null);
        }
        ...
        public static void PetCreationOptionsRequestR(LoginClient client, PetCreationOptionsListType type,
            List<int> list)
        {
