...
namespace Aura.Tests.Mabi
{
    public class ErinnTimeTests
    {
        ...
        public void ErinnTimeToString()
        {
            ...
            {
                var time = new ErinnTime(dt3.AddMilliseconds(year * 7 * 40 * 24 * 60 * 1500 +
                                                             month * 40 * 24 * 60 * 1500 + day * 24 * 60 * 1500 +
                                                             hour * 60 * 1500 + minute * 1500));
                Assert.Equal(
                    string.Format("{0}-{1}-{2:00} {3:00}:{4:00}", 628 + year, month + 1, day + 1, hour, minute),
                    time.ToString());
            }
        }
