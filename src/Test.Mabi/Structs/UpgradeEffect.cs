    ...
    public class UpgradeEffectTests
    {
        ...
        public void UpgradeEffectSkillCheck()
        {
            ...
            Assert.Throws(typeof(ArgumentException),
                () => effect.SetSkillCheck(SkillId.Smash, UpgradeCheckType.WhenBroken, SkillRank.R9));
        }
        ...
        public void UpgradeEffectStatCheck()
        {
            ...
            Assert.Throws(typeof(ArgumentException),
                () => effect.SetStatCheck(UpgradeStat.MP, UpgradeCheckType.SkillRankGreaterThan, 500,
                    UpgradeValueType.Percent));
        }
