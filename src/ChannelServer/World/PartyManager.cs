...
namespace Aura.Channel.World
{
    ...
    ///     They'll need to be given space in the DB at a later date (I really hope I'm not the one who has to write that MySQL
    ///     DB update..)
    /// </summary>
    public class PartyManager
    {
        ...
        ///     but I feel like I'd regret not putting in place..?
        /// </remarks>
