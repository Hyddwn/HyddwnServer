...
namespace Aura.Channel.World.Weather
{
    ...
    {
        private readonly Dictionary<int, IWeatherProvider> _providers;
        ...
        public void Initialize()
        {
            ...
            ChannelServer.Instance.Events.PlayerEntersRegion += OnPlayerEntersRegion;
        ...
        {
            var provider = GetProvider(creature.RegionId);
            if (provider == null)
            {
        ...
        {
            var provider = GetProvider(regionId);
            if (provider == null)
                return;
