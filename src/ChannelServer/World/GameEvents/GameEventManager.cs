...
namespace Aura.Channel.World.GameEvents
{
    ...
    public class GameEventManager
    {
        ...
        {
            GlobalBonuses = new GlobalBonusManager();
        }

        /// <summary>
        ///     Global bonuses for AP, EXP, etc.
        /// </summary>
        public GlobalBonusManager GlobalBonuses { get; }
        ...
        public int CountActive
        {
            get
            {
                lock (_gameEvents)
                {
                    return _gameEvents.Values.Where(a => a.IsActive).Count();
                }
            }
        }
        ...
        public bool AnyActive
        {
            get
            {
                lock (_gameEvents)
                {
                    return _gameEvents.Values.Any(a => a.IsActive);
                }
            }
        }
