...
namespace Aura.Channel.World.Dungeons.Props
{
    ...
    public class Fountain : DungeonProp
    {
        ...
        private readonly HashSet<long> _touchedBy;
        private int count;
            ...
            : base(311, name, "on")
        {
            ...
            Info.Color1 = 0xE4DFCB;
            Info.Color2 = 0x8EFCFF;
        ...
        protected virtual void Touch(Creature creature)
        {
            ...
            switch (rnd.Next(15))
            {
                ...
                case 9: // Repair One
                {
                    var equip = creature.Inventory.GetEquipment(a =>
                        a.OptionInfo.Durability != a.OptionInfo.DurabilityMax);
                    var count = equip.Count();
