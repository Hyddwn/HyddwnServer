...
namespace Aura.Channel.World.Entities.Creatures
{
    ...
    public class StatMod
    {
        public StatMod(Stat stat, float value, StatModSource source, long ident, int timeout)
        {
            ...
            Timeout = timeout;
            Start = DateTime.Now;
            End = Timeout > 0 ? Start.AddSeconds(Timeout) : DateTime.MaxValue;
        }
        ...
        /// </summary>
        public bool TimeoutReached => Timeout > 0 && End < DateTime.Now;
    }
