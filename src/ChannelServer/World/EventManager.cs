...
namespace Aura.Channel.World
{
    public class EventManager
    {
        ...
        public void OnSecondsTimeTick(ErinnTime now)
        {
        ...
        public void OnMinutesTimeTick(ErinnTime now)
        {
        ...
        public void OnHoursTimeTick(ErinnTime now)
        {
        ...
        public void OnErinnTimeTick(ErinnTime now)
        {
        ...
        public void OnErinnMidnightTick(ErinnTime now)
        {
        ...
        public void OnMabiTick(ErinnTime now)
        {
            MabiTick.Raise(now);
        }
        ...
        public void OnPlayTimeTick(ErinnTime now)
        {
            PlayTimeTick.Raise(now);
        }
        ...
        public void OnCreatureConnecting(Creature creature)
        {
            CreatureConnecting.Raise(creature);
        }
        ...
        public void OnCreatureConnected(Creature creature)
        {
            CreatureConnected.Raise(creature);
        }
        ...
        {
            PlayerEntersRegion.Raise(creature);
        }
        ...
        public void OnPlayerLeavesRegion(Creature creature)
        {
            PlayerLeavesRegion.Raise(creature);
        }
        ...
        public void OnPlayerRemovesItem(Creature creature, int itemId, int amount)
        {
            PlayerRemovesItem.Raise(creature, itemId, amount);
        }
        ...
        {
            PlayerReceivesItem.Raise(creature, itemId, amount);
        }
        ...
        public void OnPlayerUsesItem(Creature creature, Item item)
        {
            PlayerUsesItem.Raise(creature, item);
        }
        ...
        public void OnPlayerEquipsItem(Creature creature, Item item)
        {
            PlayerEquipsItem.Raise(creature, item);
        }
        ...
        public void OnPlayerUnequipsItem(Creature creature, Item item)
        {
            PlayerUnequipsItem.Raise(creature, item);
        }
        ...
        {
            PlayerCompletesQuest.Raise(creature, questId);
        }
        ...
        {
            SkillRankChanged.Raise(creature, skill);
        }
        ...
        public void OnPlayerUsedSkill(Creature creature, Skill skill)
        {
            PlayerUsedSkill.Raise(creature, skill);
        }
        ...
        {
            PlayerClearedDungeon.Raise(creature, dungeon);
        }
        ...
        public void OnPlayerHealsCreature(Creature creature, Creature target, Skill skill)
        {
            PlayerHealsCreature.Raise(creature, target, skill);
        }
        ...
        {
            CreatureKilled.Raise(creature, killer);
        }
        ...
        public void OnCreatureKilledByPlayer(Creature creature, Creature killer)
        {
            CreatureKilledByPlayer.Raise(creature, killer);
        }
        ...
        {
            CreatureFinished.Raise(creature, killer);
        }
        ...
        public void OnCreatureFinishedByPlayer(Creature creature, Creature killer)
        {
            CreatureFinishedByPlayer.Raise(creature, killer);
        }
        ...
        {
            CreatureAttackedByPlayer.Raise(action);
        }
        ...
        public void OnCreatureAttacked(TargetAction action)
        {
        ...
        {
            CreatureLevelUp.Raise(creature);
        }
        ...
        public void OnCreatureGotKeyword(Creature creature, int keywordId)
        {
            CreatureGotKeyword.Raise(creature, keywordId);
        }
        ...
        public void OnCreatureGathered(CollectEventArgs args)
        {
            CreatureGathered.Raise(args);
        }
        ...
        public void OnHandlingCombatActionPack(CombatActionPack pack)
        {
            HandlingCombatActionPack.Raise(pack);
        }
        ...
        public void OnCreatureProducedItem(ProductionEventArgs args)
        {
            CreatureProducedItem.Raise(args);
        }
        ...
        public void OnCreatureCreatedItem(CreationEventArgs args)
        {
            CreatureCreatedItem.Raise(args);
        }
        ...
        public void OnCreatureCookedMeal(CookingEventArgs args)
        {
            CreatureCookedMeal.Raise(args);
        }
        ...
        {
            CreatureFinishedProductionOrCollection.Raise(creature, success);
        }
        ...
        {
            CreatureFished.Raise(creature, item);
        }
        ...
        public void OnCreatureGotLuckyFinish(Creature creature, LuckyFinish finish, int amount)
        {
            CreatureGotLuckyFinish.Raise(creature, finish, amount);
        }
        ...
        {
            CreatureStartedPtj.Raise(creature, type);
        }
        ...
        {
            CreatureCompletedPtj.Raise(creature, type);
        }
        ...
        {
            CreatureAged.Raise(creature, prevAge);
        }
    }
