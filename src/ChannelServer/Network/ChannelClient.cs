...
namespace Aura.Channel.Network
{
    public class ChannelClient : DefaultClient
    {
        ...
        public override void CleanUp()
        {
            ...
            foreach (var creature in Creatures.Values.Where(a => a.Region != Region.Limbo))
            {
                // Close NPC sessions
            ...
            if (Account != null)
            {
                ChannelServer.Instance.Database.SaveAccount(Account);
                ChannelServer.Instance.Database.SetAccountLoggedIn(Account.Id, false);
            }
