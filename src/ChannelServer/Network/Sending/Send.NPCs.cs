...
namespace Aura.Channel.Network.Sending
{
    public static partial class Send
    {
        ...
        public static void OpenBank(Creature creature, BankInventory bank, BankTabRace race, string bankId,
            string bankTitle)
        {
        ...
        public static void BankTransferInquiry(Creature creature, long itemEntityId, string bankTitle, int time,
            int price)
        {
        ...
        public static void NpcTalkEgoR(Creature creature, bool success, long npcEntityId, string npcName,
            string description)
        {
