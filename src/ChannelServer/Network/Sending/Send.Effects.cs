...
namespace Aura.Channel.Network.Sending
{
    public static partial class Send
    {
        ...
        public static void SpawnEffect(SpawnEffect spawnEffect, int regionId, int x, int y, Creature sender,
            Creature sendFrom = null)
        {
            if (sendFrom == null)
                sendFrom = sender;
        ...
        public static void PlayEffect(Creature creature, InstrumentType instrument, PlayingQuality quality,
