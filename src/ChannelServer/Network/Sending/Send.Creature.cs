...
namespace Aura.Channel.Network.Sending
{
    public static partial class Send
    {
        ...
        ///     actually do.
        /// </remarks>
        public static void StatUpdate(Creature creature, StatUpdateType type, ICollection<Stat> stats,
            ICollection<StatRegen> regens, ICollection<StatRegen> regensRemove, ICollection<StatRegen> regensUpdate)
        {
            var packet = new Packet(type == StatUpdateType.Public ? Op.StatUpdatePublic : Op.StatUpdatePrivate,
                creature.EntityId);
            ...
            else
            {
                ...
                foreach (var stat in stats)
                {
                    ...
                    switch (stat)
                    {
                        ...
                        case Stat.CombatPower:
                            packet.PutFloat(creature.CombatPower);
                            break;
                        case Stat.Level:
                            packet.PutShort(creature.Level);
                            break;
                        case Stat.AbilityPoints:
                            packet.PutInt(creature.AbilityPoints);
                            break; // [200100, NA229 (2016-06-16)] Changed from short to int
                        ...
                        case Stat.LifeMax:
                            ...
                            break;
                        case Stat.LifeMaxMod:
                            packet.PutFloat(creature.StatMods.Get(Stat.LifeMaxMod));
                            break;
                        case Stat.LifeInjured:
                            packet.PutFloat(creature.LifeInjured);
                            break;
                        case Stat.LifeMaxFoodMod:
                        ...
                        case Stat.ManaMax:
                            ...
                            break;
                        case Stat.ManaMaxMod:
                            packet.PutFloat(creature.StatMods.Get(Stat.ManaMaxMod));
                            break;
                        case Stat.ManaMaxFoodMod:
                        ...
                        case Stat.StaminaMax:
                            ...
                            break;
                        case Stat.StaminaMaxMod:
                            packet.PutFloat(creature.StatMods.Get(Stat.StaminaMaxMod));
                            break;
                        case Stat.StaminaMaxFoodMod:
                        ...
                        case Stat.PoisonImmuneMod:
                            packet.PutShort((short) creature.StatMods.Get(Stat.PoisonImmuneMod));
                            break;
                        case Stat.ArmorPierceMod:
                            packet.PutShort((short) creature.StatMods.Get(Stat.ArmorPierceMod));
                            break;

                        case Stat.MagicAttackMod:
                            packet.PutFloat(creature.MagicAttackMod);
                            break;
                        case Stat.MagicDefenseMod:
                            packet.PutFloat(creature.MagicDefenseMod);
                            break;
                        case Stat.MagicProtectionMod:
                            packet.PutFloat(creature.MagicProtectionMod);
                            break;
