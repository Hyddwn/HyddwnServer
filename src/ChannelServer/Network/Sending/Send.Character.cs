...
namespace Aura.Channel.Network.Sending
{
    public static partial class Send
    {
        ...
        public static void EnterDynamicRegion(Creature creature, int warpFromRegionId, Region warpToRegion, int x,
            int y)
        {
        ...
        {
            var packet = new Packet(Op.AcquireInfo2, creature.EntityId);
            packet.PutString("<xml type='cooking' objectid='{0}' classid='{1}' success='{2}' />", objectid, classid,
                success ? 1 : 0);
            packet.PutInt(3000);
        ...
        {
            var packet = new Packet(Op.AcquireInfo2, creature.EntityId);
            packet.PutString("<xml type='enchant' objectid='{0}' classid='{1}' value='{2}' optionset='{3}'/>",
                itemEntityId, itemId, 4, optionSetId);
            packet.PutInt(3000);
