...
namespace Aura.Channel.Network.Sending
{
    public static partial class Send
    {
        ...
        public static void SkillUsePlayingInstrument(Creature creature, SkillId skillId, InstrumentType instrument,
            string compressedMML, int rndScore)
        {
            var packet = new Packet(Op.SkillUse, creature.EntityId);
            packet.PutUShort((ushort) skillId);
            packet.PutLong(0);
        ...
        public static void SkillCompleteUnk(Creature creature, SkillId skillId, long entityId, int unkInt,
            short unkShort)
        {
        ...
        /// </param>
        public static void ProductionSuccessRequestR(Creature creature, SkillId skillId, float successRate,
            bool totalSuccess)
        {
        ...
        /// </param>
        public static void ProductionSuccessRequestR(Creature creature, SkillId skillId, float successRate,
            bool totalSuccess, float unkFloat)
        {
            var gp = new Packet(Op.ProductionSuccessRequestR, creature.EntityId);
        ...
        public static void BlacksmithingMiniGame(Creature creature, Prop prop, Item item, List<BlacksmithDot> dots,
            int deviation)
        {
