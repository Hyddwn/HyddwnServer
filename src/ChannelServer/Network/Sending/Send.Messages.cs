...
namespace Aura.Channel.Network.Sending
{
    public static partial class Send
    {
        ...
        public static void PartyAdChat(Party party)
        {
            ...
            packet.PutString(Localization.Get("[Wanted] {0}: [{1}/{2}] - {3}"), party.Leader.Name, party.Name,
                party.DungeonLevel, party.Info);
            packet.PutByte(1);
            packet.PutInt(-1);
            packet.PutInt(0);
            packet.PutByte(2);
        ...
        /// <param name="format"></param>
        /// <param name="args"></param>
        public static void MsgBox(Creature creature, MsgBoxTitle title, MsgBoxButtons buttons, MsgBoxAlign align,
        ...
        /// <param name="format"></param>
        /// <param name="args"></param>
        public static void MsgBox(Creature creature, string title, MsgBoxButtons buttons, MsgBoxAlign align,
            string format, params object[] args)
        {
        ...
        /// <param name="format"></param>
        /// <param name="args"></param>
        public static void Notice(Creature creature, NoticeType type, int duration, int delay, string format,
            params object[] args)
        {
            var packet = new Packet(Op.Notice, MabiId.Broadcast);
            packet.PutByte((byte) type);
        ...
        public static void RequestClientDisconnect(int time)
        {
            ChannelServer.Instance.World.Broadcast(
                new Packet(Op.RequestClientDisconnect, MabiId.Channel).PutInt(time * 1000));
        }
    }
}