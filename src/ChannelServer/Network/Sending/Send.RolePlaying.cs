...
namespace Aura.Channel.Network.Sending
{
    public static partial class Send
    {
        ...
        {
            var packet = new Packet(Op.RequestSecondaryLogin, MabiId.Channel);
        ...
        {
            var packet = new Packet(Op.StartRP, MabiId.Channel);
            packet.PutLong(entityId);
        ...
        {
            var packet = new Packet(Op.EndRP, MabiId.Channel);
