        ...
        public void Revive(ChannelClient client, Packet packet)
        {
            ...
            switch (option)
            {
                ...
                case ReviveOptions.BarriLobby:
                    creature.Warp(
                        "Ula_DgnHall_Bangor_before1/_Ula_DgnHall_Bangor_before1/DG_BangorBefore1_Outer_Spawn");
                    creature.Revive(option);
                    return;
                ...
                case ReviveOptions.DungeonEntrance:
                    ...
                    {
                        Log.Warning("Dungeon revive outside of dungeon or without save location (Creature: {0:X16})",
                            creature.EntityId);
                        break;
                    }
