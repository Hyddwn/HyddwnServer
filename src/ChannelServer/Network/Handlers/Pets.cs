...
namespace Aura.Channel.Network.Handlers
{
    public partial class ChannelServerHandlers : PacketHandlerManager<ChannelClient>
    {
        ...
        public void PetAction(ChannelClient client, Packet packet)
        {
            ...
            {
                Log.Warning("PetAction: Creature '{0:X16}' ({1}) tried to use unknown action '{2}'.", pet.EntityId,
                    pet.RaceId, action);
                return;
            }
        ...
        public void PutItemIntoPetInv(ChannelClient client, Packet packet)
        {
            ...
            if (pet.IsPartner && !CreatureInventory.AccessiblePockets.Contains(pocket) ||
                !pet.IsPartner && pocket != Pocket.Inventory)
