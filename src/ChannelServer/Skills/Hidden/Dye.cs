...
namespace Aura.Channel.Skills.Hidden
{
    ...
    public class Dye : IPreparable, IUseable, ICompletable, ICancelable
    {
        ...
        public void Complete(Creature creature, Skill skill, Packet packet)
        {
            ...
            switch (packet.Peek())
            {
                ...
                case PacketElementType.Byte:
                    CompleteFixed(creature, packet, skill, part);
                    break;
            }
        }
        ...
        public void Use(Creature creature, Skill skill, Packet packet)
        {
            ...
            {
                case PacketElementType.Short:
                    UseRegular(creature, skill, packet, part);
                    break;
                case PacketElementType.Byte:
                    UseFixed(creature, skill, packet, part);
                    break;
            }
        }
        ...
        private void CompleteRegular(Creature creature, Packet packet, Skill skill, int part)
        {
            ...
            switch (rnd.Next(5))
            {
                default:
                case 0:
                    picker = creature.Temp.RegularDyePickers.Picker1;
                    break;
                case 1:
                    picker = creature.Temp.RegularDyePickers.Picker2;
                    break;
                case 2:
                    picker = creature.Temp.RegularDyePickers.Picker3;
                    break;
                case 3:
                    picker = creature.Temp.RegularDyePickers.Picker4;
                    break;
                case 4:
                    picker = creature.Temp.RegularDyePickers.Picker5;
                    break;
            }
            ...
            try
            {
                switch (part)
                {
                    default:
                    case 0:
                        item.Info.Color1 = GetRegularColor(data.ColorMap1, a1, a2, a3, a4, x, y);
                        break;
                    case 1:
                        item.Info.Color2 = GetRegularColor(data.ColorMap2, a1, a2, a3, a4, x, y);
                        break;
                    case 2:
                        item.Info.Color3 = GetRegularColor(data.ColorMap3, a1, a2, a3, a4, x, y);
                        break;
                }
                DyeSuccess(creature);
        ...
        private void CompleteFixed(Creature creature, Packet packet, Skill skill, int part)
        {
            ...
            switch (part)
            {
                default:
                case 0:
                    creature.Temp.SkillItem1.Info.Color1 = creature.Temp.SkillItem2.Info.Color1;
                    break;
                case 1:
                    creature.Temp.SkillItem1.Info.Color2 = creature.Temp.SkillItem2.Info.Color1;
                    break;
                case 2:
                    creature.Temp.SkillItem1.Info.Color3 = creature.Temp.SkillItem2.Info.Color1;
                    break;
            }
        ...
        private static uint GetRegularColor(int colorMapId, int a1, int a2, int a3, int a4, int x, int y)
        {
            ...
            else
            {
                ...
                for (var i = 0; i < MapSize; ++i)
                {
                    ...
                    for (var fidx = 0; fidx < outstride; fidx += instride)
                        Buffer.BlockCopy(mapData.Raw, midx, raw, fidx + i * outstride,
                            Math.Min(instride, outstride - fidx));
                }
            }
