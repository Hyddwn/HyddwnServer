...
namespace Aura.Channel.Skills.Transformations
{
    ...
    public class SpiritOfOrderHandler : StartStopSkillHandler, IInitiableSkillHandler
    {
        ...
        public override StartStopResult Start(Creature creature, Skill skill, MabiDictionary dict)
        {
            ...
            Transform(creature, skill);
            GiveBonuses(creature, skill);
            SetTimers(creature, skill);
        ...
        public override StartStopResult Stop(Creature creature, Skill skill, MabiDictionary dict)
        {
            ...
            RemoveBonuses(creature, skill);
            ResetTransformation(creature, skill);
        ...
        {
            var duration = GetDuration(creature, skill);
            duration = TimeSpan.FromMilliseconds(Math.Max(1000,
                duration.TotalMilliseconds * ChannelServer.Instance.Conf.World.PaladinDurationRate));
        ...
        private void GiveBonuses(Creature creature, Skill skill)
        {
            ...
            {
                creature.StatMods.Add(Stat.MagicDefenseMod, skill.RankData.Var8, StatModSource.Skill,
                    (long) skill.Info.Id);
                creature.StatMods.Add(Stat.MagicProtectionMod, skill.RankData.Var9, StatModSource.Skill,
                    (long) skill.Info.Id);
            }
            ...
            if (powerOfOrder != null)
            {
                ...
                creature.StatMods.Add(Stat.StrMod, powerOfOrder.RankData.Var1, StatModSource.Skill,
                    (long) skill.Info.Id);
                creature.StatMods.Add(Stat.WillMod, powerOfOrder.RankData.Var2, StatModSource.Skill,
                    (long) skill.Info.Id);
            }
            ...
            if (eyeOfOrder != null)
            {
                ...
                creature.StatMods.Add(Stat.DexMod, powerOfOrder.RankData.Var1, StatModSource.Skill,
                    (long) skill.Info.Id);
                creature.StatMods.Add(Stat.BalanceMod, powerOfOrder.RankData.Var2, StatModSource.Skill,
                    (long) skill.Info.Id);
            }
            ...
            if (swordOfOrder != null)
            {
                ...
                creature.StatMods.Add(Stat.AttackMinMod, swordOfOrder.RankData.Var1, StatModSource.Skill,
                    (long) skill.Info.Id);
                creature.StatMods.Add(Stat.AttackMaxMod, swordOfOrder.RankData.Var1, StatModSource.Skill,
                    (long) skill.Info.Id);
                creature.StatMods.Add(Stat.InjuryMinMod, swordOfOrder.RankData.Var2, StatModSource.Skill,
                    (long) skill.Info.Id);
                creature.StatMods.Add(Stat.InjuryMaxMod, swordOfOrder.RankData.Var2, StatModSource.Skill,
                    (long) skill.Info.Id);
            }
            ...
            if (passives != "")
            {
                ...
                Send.Notice(creature, NoticeType.Middle, 0, EffectBaseDelay,
                    Localization.Get(passives + " activated."));
            }
        }
        ...
        private void RemoveBonuses(Creature creature, Skill skill)
        {
            ...
            // Disable skills
            creature.Skills.SetEnabled(false, SkillId.PowerOfOrder, SkillId.EyeOfOrder, SkillId.SwordOfOrder,
                SkillId.PaladinNaturalShield, SkillId.PaladinHeavyStander, SkillId.PaladinManaDeflector);
        }
