...
namespace Aura.Channel.Skills.Base
{
    ...
    /// </summary>
    public abstract class MagicBolt : IPreparable, IReadyable, ICombatSkill, ICompletable, ICancelable,
        IInitiableSkillHandler, ICustomHitCanceler, ICustomPrepareUsageSkill
    {
        /// <summary>
        ...
        /// </summary>
        protected virtual short AttackerStun => 500;

        /// <summary>
        ///     Stun time of target after being hit in ms.
        /// </summary>
        protected virtual short TargetStun => 2000;

        /// <summary>
        ///     Units the target is knocked back.
        /// </summary>
        protected virtual int KnockbackDistance => 400;

        /// <summary>
        ///     Amount added to the knock back meter on each hit.
        /// </summary>
        protected virtual float StabilityReduction => 45;
        ...
        public virtual CombatSkillResult Use(Creature attacker, Skill skill, long targetEntityId)
        {
            ...
            if (!attackerPosition.InRange(targetPosition, GetRange(attacker, skill)))
            ...
            // Use
            UseSkillOnTarget(attacker, skill, target);
        ...
        public void CustomPrepareUsage(Creature creature, Skill skill)
        {
            ...
            var addedStacks = Math.Min(skill.RankData.StackMax - skill.Stacks,
                skill.RankData.Stack + creature.GetChainCastLevel(skill.Info.Id));
            cost *= addedStacks;
        ...
        {
            ChannelServer.Instance.Events.CreatureAttack += OnCreatureAttack;
        }
