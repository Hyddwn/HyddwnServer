...
namespace Aura.Channel.Skills.Life
{
    ...
    public class FirstAid : ISkillHandler, IPreparable, IReadyable, IUseable, ICompletable, ICancelable
    {
        ...
        public void Complete(Creature creature, Skill skill, Packet packet)
        {
            ...
            if (creature.Temp.SkillItem1 == null || !creature.Temp.SkillItem1.HasTag("/bandage/") ||
                !creature.Inventory.Has(creature.Temp.SkillItem1))
            {
                Log.Warning(
                    "FirstAid.Complete: Creature '{0:X16}' apparently switched the skill item somehow, between Ready and Complete.",
                    creature.EntityId);
        ...
        public bool Prepare(Creature creature, Skill skill, Packet packet)
        {
            ...
            if (itemEntityId != 0)
            {
                ...
                {
                    Log.Warning("FirstAid.Prepare: Creature '{0:X16}' tried to use invalid bandage.",
                        creature.EntityId);
                    return false;
                }
            }
