...
namespace Aura.Channel.Skills.Combat
{
    ...
    public class ManaDeflector : StartStopSkillHandler
    {
        ...
        {
            SkillId.ManaDeflector, SkillId.ManaDeflectorPassive, SkillId.PaladinManaDeflector,
            SkillId.DarkManaDeflector, SkillId.ConnousManaDeflector, SkillId.PhysisManaDeflector
        };
            ...
            TargetAction tAction)
        {
            ...
            for (var i = 0; i < Skills.Length; ++i)
            {
                ...
                if (skill != null && (skill.Info.Id == SkillId.ManaDeflectorPassive || skill.Enabled ||
