    ...
    public class FinalHit : StandardPrepareHandler, IUseable, IInitiableSkillHandler, ICustomHitCanceler
    {
        ...
        private void OnCreatureAttack(TargetAction tAction)
        {
            ...
            if (tAction.Creature.IsDead)
                ...
                {
                    case PowerRating.Strong:
                        tAction.Attacker.Temp.FinalHitKillCountStrong++;
                        goto default;
                    case PowerRating.Awful:
                        tAction.Attacker.Temp.FinalHitKillCountAwful++;
                        goto default;
                    case PowerRating.Boss:
                        tAction.Attacker.Temp.FinalHitKillCountBoss++;
                        goto default;
                    default:
                        tAction.Attacker.Temp.FinalHitKillCount++;
                        break;
                }
