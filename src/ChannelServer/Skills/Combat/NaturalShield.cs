...
namespace Aura.Channel.Skills.Combat
{
    ...
    public class NaturalShield : StartStopSkillHandler
    {
        ...
        private static readonly SkillId[] Skills =
        {
            SkillId.NaturalShield, SkillId.NaturalShieldPassive, SkillId.PaladinNaturalShield,
            SkillId.DarkNaturalShield, SkillId.ConnousNaturalShield, SkillId.PhysisNaturalShield
        };
        ...
        public static PassiveDefenseResult Handle(Creature attacker, Creature target, ref float damage,
            TargetAction tAction)
        {
            ...
            for (var i = 0; i < Skills.Length; ++i)
            {
                ...
                if (skill != null && (skill.Info.Id == SkillId.NaturalShieldPassive || skill.Enabled ||
                                      skill.Has(SkillFlags.InUse)))
                {
