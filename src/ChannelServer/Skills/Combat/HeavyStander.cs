...
namespace Aura.Channel.Skills.Combat
{
    ...
    public class HeavyStander : StartStopSkillHandler
    {
        ...
        {
            SkillId.HeavyStander, SkillId.HeavyStanderPassive, SkillId.PaladinHeavyStander, SkillId.DarkHeavyStander,
            SkillId.ConnousHeavyStander, SkillId.PhysisHeavyStander
        };
        ...
        public static bool Handle(Creature attacker, Creature target, ref float damage, TargetAction tAction)
        {
            ...
            for (var i = 0; i < Skills.Length; ++i)
            {
                ...
                if (skill != null && (skill.Info.Id == SkillId.HeavyStanderPassive || skill.Enabled ||
