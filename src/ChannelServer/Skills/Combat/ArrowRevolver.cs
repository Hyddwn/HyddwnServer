...
namespace Aura.Channel.Skills.Combat
{
    ...
    public class ArrowRevolver : ISkillHandler, IPreparable, IReadyable, ICompletable, ICancelable, ICombatSkill,
        ...
        public bool Ready(Creature creature, Skill skill, Packet packet)
        {
            ...
            if (creature.RightHand != null && creature.RightHand.HasTag("/bow/"))
                creature.Temp.FireArrow = creature.Region
                                              .GetProps(a =>
                                                  a.Info.Id == 203 &&
                                                  a.GetPosition().InRange(creature.GetPosition(), 500)).Count > 0;
