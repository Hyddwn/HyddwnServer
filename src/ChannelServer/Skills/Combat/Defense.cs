        ...
        public void OnCreatureAttack(TargetAction tAction)
        {
            ...
            if (attackerSkill != null)
                switch (attackerSkill.Info.Rank)
                {
                    ...
                    case SkillRank.R2:
                    case SkillRank.R1:
                        if (tAction.AttackerSkillId == SkillId.Smash || tAction.AttackerSkillId == SkillId.MagnumShot ||
                            tAction.AttackerSkillId == SkillId.Firebolt ||
                            tAction.AttackerSkillId == SkillId.WaterCannon ||
                            tAction.AttackerSkillId == SkillId.AssaultSlash)
