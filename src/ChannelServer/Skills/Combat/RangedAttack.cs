...
namespace Aura.Channel.Skills.Combat
{
        ...
        IInitiableSkillHandler
    {
        ...
        public CombatSkillResult Use(Creature attacker, Skill skill, long targetEntityId)
        {
            ...
            var attackerStun =
                (short) (actionType == CombatActionPackType.ChainRangeAttack ? AttackerStunElf : AttackerStun);
            ...
            for (byte i = 1; i <= maxHits; ++i)
            {
                ...
                if (successfulHit)
                {
                    ...
                    tAction.Stun = (short) (actionType == CombatActionPackType.ChainRangeAttack
                        ? TargetStunElf
                        : TargetStun);
                    ...
                    else
                    {
                        ...
                        {
                            var stabilityReduction = actionType == CombatActionPackType.ChainRangeAttack
                                ? StabilityReductionElf
                                : StabilityReduction;
