	...
	public class DiceTossing : ISkillHandler, IPreparable, IReadyable, IUseable, ICompletable, ICancelable
	{
		...
		public void Use(Creature creature, Skill skill, Packet packet)
		{
           ...
           // Send.ItemAmount(creature, ); Remove 1 item
            ...
            Send.Effect(creature, Effect.Dice, "process", unklong, (byte)3);
            Send.SkillUse(creature, skill.Info.Id, unklong, unkInt3, unkInt4);
            skill.Stacks = 0;
		...
		public void Complete(Creature creature, Skill skill, Packet packet)
		{
			...
			Send.SkillComplete(creature, skill.Info.Id, unklong, unkInt3, unkInt4);
		}
