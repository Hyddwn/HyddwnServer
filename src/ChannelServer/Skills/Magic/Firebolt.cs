...
namespace Aura.Channel.Skills.Magic
{
    ...
    public class Firebolt : MagicBolt
    {
        ...
        /// </summary>
        protected override SkillId SkillId => SkillId.Firebolt;

        /// <summary>
        ///     String used in effect packets.
        /// </summary>
        protected override string EffectSkillName => "firebolt";

        /// <summary>
        ///     Weapon tag that's looked for in range calculation.
        /// </summary>
        protected override string SpecialWandTag => "fire_wand";
