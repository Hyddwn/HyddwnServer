...
namespace Aura.Channel.Skills.Magic
{
    ...
    public class Healing : ISkillHandler, IPreparable, IReadyable, IUseable, ICancelable, ICompletable,
        IInitiableSkillHandler, ICustomHitCanceler
    {
        /// <summary>
        ...
        public void Use(Creature creature, Skill skill, Packet packet)
        {
            ...
            OnUseSkillOnTarget(creature, target);
        ...
        private void OnPlayerUsesItem(Creature creature, Item item)
        {
            ...
            if (userSkill != null && userSkill.Info.Rank >= SkillRank.RF && userSkill.Info.Rank <= SkillRank.RE &&
                item.HasTag("/potion/hp/"))
