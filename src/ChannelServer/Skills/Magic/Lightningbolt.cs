...
namespace Aura.Channel.Skills.Magic
{
    ...
    public class Lightningbolt : MagicBolt
    {
        ...
        /// </summary>
        protected override SkillId SkillId => SkillId.Lightningbolt;

        /// <summary>
        ///     String used in effect packets.
        /// </summary>
        protected override string EffectSkillName => "lightningbolt";

        /// <summary>
        ///     Weapon tag that's looked for in range calculation.
        /// </summary>
        protected override string SpecialWandTag => "lightning_wand";
            ...
            for (var i = 0; i < max; ++i)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        // reduction to 0.
                        var stabilityReduction = skill.Stacks > targets.Count
                            ? OverchargeStabilityReduction
                            : StabilityReduction;
