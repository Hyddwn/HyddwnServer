...
namespace Aura.Mabi.Const
{
    ...
    public static class PocketExtensions
    {
        ...
        {
            if (pocket >= Pocket.Face && pocket <= Pocket.Accessory2 ||
                pocket >= Pocket.ArmorStyle && pocket <= Pocket.RobeStyle || pocket == Pocket.TailStyle)
                return true;
            return false;
        }
        ...
        public static bool IsMainEquip(this Pocket pocket, WeaponSet set)
        {
            if (
                ...
                set == WeaponSet.First && (pocket == Pocket.RightHand1 || pocket == Pocket.LeftHand1 ||
                                           pocket == Pocket.Magazine1) ||
                set == WeaponSet.Second && (pocket == Pocket.RightHand2 || pocket == Pocket.LeftHand2 ||
                                            pocket == Pocket.Magazine2) ||
