...
namespace Aura.Mabi.Structs
{
    ...
    public struct ItemInfo
    {
        ...
        private readonly short __unknown7;
        public int Region;
        public int X;
        public int Y;
        ...
        private readonly byte __unknown12;
        private readonly byte __unknown13;
        private readonly byte __unknown14;
    }
    ...
    {
        [FieldOffset(0)] public ItemFlags Flags;
        [FieldOffset(1)] public byte __unknown15;
        [FieldOffset(2)] public byte __unknown16;
        [FieldOffset(3)] public byte __unknown17;

        [FieldOffset(4)] public int Price;
        [FieldOffset(8)] public int SellingPrice;

        [FieldOffset(12)] public Pocket LinkedPocketId;

        [FieldOffset(16)] public int Durability;
        [FieldOffset(20)] public int DurabilityMax;
        [FieldOffset(24)] public int DurabilityOriginal;

        [FieldOffset(28)] public ushort AttackMin;
        [FieldOffset(30)] public ushort AttackMax;

        [FieldOffset(32)] public ushort InjuryMin;
        [FieldOffset(34)] public ushort InjuryMax;

        [FieldOffset(36)] public byte Balance;
        [FieldOffset(37)] public sbyte Critical;
        [FieldOffset(38)] public byte __unknown24;
        [FieldOffset(39)] public byte __unknown25;

        [FieldOffset(40)] public int Defense;

        [FieldOffset(44)] public short Protection;
        [FieldOffset(46)] public short EffectiveRange;

        [FieldOffset(48)] public AttackSpeed AttackSpeed;
        [FieldOffset(49)] public byte KnockCount;
        [FieldOffset(50)] public short Experience;

        [FieldOffset(52)] public byte EP;
        [FieldOffset(53)] public byte Upgraded;
        [FieldOffset(54)] public byte UpgradeMax;
        [FieldOffset(55)] public byte WeaponType;

        [FieldOffset(56)] public int Grade;

        [FieldOffset(60)] public ushort Prefix;
        [FieldOffset(62)] public ushort Suffix;

        [FieldOffset(64)] public short Elemental;
        [FieldOffset(66)] public short __unknown31;

        [FieldOffset(68)] public int ExpireTime;
        [FieldOffset(72)] public int StackRemainingTime;
        [FieldOffset(76)] public int JoustPointPrice;
        [FieldOffset(80)] public int DucatPrice;
        [FieldOffset(84)] public int StarPrice;
        [FieldOffset(88)] public int PointPrice;
        [FieldOffset(92)] public int __unknown3;

        // [1XXXXX] Purpose unknown, added some time
        // between G15 and G19.
        [FieldOffset(96)] public int __unknown96;
    }
    ...
    public struct UpgradeEffect
    {
        ...
        ///     Type of upgrade.
        /// </summary>
        [FieldOffset(0)] public UpgradeType Type;

        /// <summary>
        ///     ?
        /// </summary>
        [FieldOffset(4)] public int Unk1;
        ...
        ///     Elemental: 0x02 ?
        /// </remarks>
        [FieldOffset(8)] public int Unk2;

        /// <summary>
        ///     Stat modified by the upgrade.
        /// </summary>
        [FieldOffset(12)] public UpgradeStat Stat;

        /// <summary>
        ///     How the value is applied.
        /// </summary>
        [FieldOffset(13)] public UpgradeValueType ValueType;

        /// <summary>
        ///     Modifier for the stat.
        /// </summary>
        [FieldOffset(14)] public short Value;

        /// <summary>
        ///     Skill id used for UpgradeStat.Skill.
        /// </summary>
        [FieldOffset(16)] public SkillId SkillId;

        /// <summary>
        ///     Skill variable to modify for UpgradeStat.Skill.
        /// </summary>
        [FieldOffset(18)] public short SkillVar;
        ...
        ///     Has to be 0x0A?
        /// </remarks>
        [FieldOffset(20)] public int Unk4;

        /// <summary>
        ///     ?
        /// </summary>
        [FieldOffset(24)] public int Unk5;
        ...
        /// </remarks>
        [FieldOffset(28)] public UpgradeCheckType CheckType;
        ...
        /// </remarks>
        [FieldOffset(32)] public bool CheckBroken;

        /// <summary>
        ///     Title id to check for with UpgradeCheckType.HoldingTitle.
        /// </summary>
        [FieldOffset(32)] public ushort CheckTitleId;

        /// <summary>
        ///     Condition to check for with UpgradeCheckType.InAStateOf.
        /// </summary>
        [FieldOffset(32)] public ushort CheckCondition;

        /// <summary>
        ///     How to apply the check, e.g. value vs percentage.
        /// </summary>
        [FieldOffset(33)] public UpgradeValueType CheckValueType;

        /// <summary>
        ///     The value to check for.
        /// </summary>
        [FieldOffset(34)] public short CheckValue;
        ...
        /// </summary>
        [FieldOffset(32)] public SkillId CheckSkillId;

        /// <summary>
        ///     Skill rank to compare to.
        /// </summary>
        [FieldOffset(35)] public SkillRank CheckSkillRank;
        ...
        {
            if (summonStat != UpgradeStat.Pet && summonStat != UpgradeStat.BarrierSpikes &&
                summonStat != UpgradeStat.Golem)
