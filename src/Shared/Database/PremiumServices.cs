...
namespace Aura.Shared.Database
{
    ...
    public class PremiumServices
    {
        ...
        /// </summary>
        public bool HasInventoryPlusService => InventoryPlusExpiration > DateTime.Now;

        /// <summary>
        ///     Returns true if Premium Service is currently active.
        /// </summary>
        public bool HasPremiumService => PremiumExpiration > DateTime.Now;

        /// <summary>
        ///     Returns true if VIP Service is currently active.
        /// </summary>
        public bool HasVipService => VipExpiration > DateTime.Now;

        /// <summary>
        ///     Returns true if account is allowed to use bags.
        /// </summary>
        public bool CanUseBags => HasInventoryPlusService || HasPremiumService || HasVipService;

        /// <summary>
        ///     Returns true if account is allowed to use all bank tabs,
        ///     not only its own.
        /// </summary>
        public bool CanUseAllBankTabs => HasInventoryPlusService || HasPremiumService || HasVipService;
        ...
        public void EvaluateFreeServices(PremiumConfFile premiumConfFile)
        {
            ...
            if (premiumConfFile.FreeInventoryPlus)
                InventoryPlusExpiration = freeExpiration;

            if (premiumConfFile.FreePremium)
                PremiumExpiration = freeExpiration;

            if (premiumConfFile.FreeVip)
                VipExpiration = freeExpiration;
        }
    }
}