...
namespace Aura.Shared.Util
{
    public static class Extensions
    {
        ...
        {
            return str.Chunkify(maxChunkLength, Localization.Get(" ").ToCharArray(),
                Localization.Get("-").ToCharArray());
        }
        ...
        /// <returns></returns>
        public static IEnumerable<string> Chunkify(this string str, int maxChunkLength, char[] removedSplitters,
            char[] keptSplitters)
        {
            ...
            while (startIndex < str.Length)
            {
                ...
                if (!splitters.Contains(str[endIndex]) && endIndex != str.Length - 1 &&
                    !splitters.Contains(str[endIndex + 1]))
                {
